...
export const readFileTool: ToolDefinition<ReadFileInput, ReadFileOutput> = {
  ...
  description: "Read a UTF-8 file inside the module root. The path argument is relative to the module root — do not include the module path prefix.",
  inputSchema: {
    type: "object",
    properties: {
...
export const writeFileTool: ToolDefinition<WriteFileInput, WriteFileOutput> = {
  ...
  description: "Write a UTF-8 file inside the module root. The path argument is relative to the module root — do not include the module path prefix.",
  inputSchema: {
    type: "object",
    properties: {
      path: { type: "string", minLength: 1 },
